...
function ParallaxEvent(props) {
  let classes = useStyles();
  return (
    <React.Fragment>
      <Parallax bgImage={tedxbg} strength={600}>
        <div className={classes.root}>
          <Hidden smUp>{/* card  */}</Hidden>
          <Hidden smDown>{/*custom div*/}</Hidden>
        </div>
      </Parallax>
    </React.Fragment>
  );
...
<React.Fragment>
  ...
  <Parallax bgImage={litFestbg} strength={600}>
    ...
    >
      <Card style={{ width: "90%" }}>
        <CardActionArea>
          <CardMedia image={litfest} style={{ height: 200 }} title='event' />
          <CardContent>
